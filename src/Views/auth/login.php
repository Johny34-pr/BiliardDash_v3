...
<div class="max-w-md mx-auto reveal">
    ...
    <form method="POST" action="/belepes" class="card p-6 md:p-8 space-y-5" novalidate>
        ...
        <!--
            Belépési adatok megjegyzése: bejelölve egy külön, lejárattal
            ellátott süti tartja fenn a belépést a böngésző bezárása után is.
            Kilépéskor érvénytelenné válik.
        -->
        <div class="flex items-start gap-3">
            ...
            <div class="min-w-0">
                <label for="remember" class="font-medium text-sand-900 cursor-pointer">
                    Emlékezz rám
                </label>
                <p id="remember-hint" class="text-sm text-sand-500 mt-0.5">
                    Belépve maradok ezen az eszközön 30 napig. Közös gépen ne jelöld be.
                </p>
            </div>
        </div>
