...
<div class="max-w-5xl">
    ...
    <header class="mb-7">
        <p class="eyebrow mb-2">Új bejegyzés</p>
        <h1 class="text-2xl md:text-3xl font-bold tracking-tightest text-billiard-green-900">Új hír létrehozása</h1>
    </header>

    <form method="POST" action="/admin/hirek/uj" class="card p-6 md:p-8 space-y-6">
        ...
        <div>
            ...
            <input type="text" id="title" name="title" maxlength="200"
                   value="<?= e($data['title'] ?? '') ?>"
                   placeholder="pl. Országos döntő eredményei"
